...
python3 scripts/check_please.py --agent-tool claude-code --session ~/.claude/usage-data/session-meta/${CLAUDE_SESSION_ID}.json --chat-reply
...
python3 scripts/check_please.py --agent-tool kimi-code
...
python3 scripts/check_please.py --provider alibaba --agent-tool trae --model qwen3.6-plus --input-tokens 1000000 --output-tokens 1000000
...
```bash
python3 scripts/check_please.py --agent-tool kimi-code
python3 scripts/check_please.py --session ~/.kimi/sessions/<hash>/<session-id>/context.jsonl
```
